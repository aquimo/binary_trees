...
/**
 * binary_tree_height - Funct that measur the height of a bin tree
...
/**
 * binary_tree_balance - Measur balance factor of a bin tree
 * @tree: tree to go through
...
/**
 * binary_tree_is_heap - checks if a bin tree is a valid Max Binary Heap
 * @tree: tree to check
 * Return: 1 is it is or 0 if not
 */
