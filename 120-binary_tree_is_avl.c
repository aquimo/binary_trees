...
/**
 * binary_tree_height - measur the height of a binary tree
 ...
 * @tree: point to the tree to check.
 * @high: point to the higher node selected
 * @lower: point to the lower node selected.
...
/**
 * binary_tree_is_avl - check if a bin tree is valid AVL tree.
 * @tree: point to the tree to check.
 * Return: 1 if tree is AVL, 0 if not.
 */
