...
/**
 * r_insert_node - Is a node value instert in AVL.
 * @tree: type pointer of root node.
 * @parent: Is a parent node of struct AVL.
 * @new: type pointer left or right insertion.
 * @nval: insert value of the AVL.
 * Return: pointer to the new root
 * after insertion otherwise NULL
 */
